CREATE TABLE Enregistrement (ID BIGINT IDENTITY NOT NULL, DESCRIPTION VARCHAR, DURÉE INTEGER, NOM VARCHAR, REPETITION INTEGER, ID_CATEGORIE BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE Jointure (ID BIGINT IDENTITY NOT NULL, NOM VARCHAR, W BIGINT, WX BIGINT, WY BIGINT, WZ BIGINT, X BIGINT, Y BIGINT, Z BIGINT, ID_FRAME BIGINT, PRIMARY KEY (ID))
